      ...
      `}>
        {selectedUser ? (
          <>
            ...
            <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-4 custom-scrollbar bg-[url('https://www.transparenttextures.com/patterns/dark-matter.png')]">
              <div className="text-center py-4">
                <span className="px-4 py-1.5 bg-white/5 rounded-full text-[9px] font-black text-gray-600 uppercase tracking-widest border border-white/5">Seguro</span>
              </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center p-10 animate-in fade-in zoom-in duration-700">
            ...
            <h3 className="text-2xl font-black text-white uppercase tracking-tight mb-2">Mensagens</h3>
            <p className="text-gray-500 max-w-sm text-sm font-medium leading-relaxed">Seleciona uma conversa estratégica.</p>
          </div>
        )}
      </div>
    </div>
